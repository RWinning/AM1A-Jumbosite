<?php
        ...
        class LoginClass
        {
			...
			public static function insert_into_loginClass($post_array)
			{
				...
				$tm_password = $date.$post_array['email'];
				$hash_form_tm_password = MD5 ($tm_password);
				var_dump($post_array); exit(); 
				
				$query = "INSERT INTO `login1` (`id`, `email`, `password`, `userrole`, `activated`, `activationdate`)
						  VALUES                ('NULL', '', '', 'customer', 'no', '".$date."')";
